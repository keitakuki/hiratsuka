...
def custom_model_4(inputs):
    ...
    x = Dense(int(inputs_size/2), activation='relu')(x)
    x = Dropout(0.5)(x)
...
def custom_model_5(inputs):
    ...
    x = Dense(int(inputs_size/10), activation='relu')(x)
    x = Dropout(0.5)(x)
...
min_loss = 1e10
for i in range(1,5):
    model = custom_model_5(train_inputs)
    model, history = custom_fit(model, train_inputs, train_label, ((np.array(test_inputs)), (np.array(test_label))))
    loss = mean_squared_error(model.predict(np.array(test_inputs)), test_label)
    if loss < min_loss:
       min_loss = loss
...
min_loss = 1e10
for i in range(1,5):
    model = custom_model_6(train_inputs)
    model, history = custom_fit(model, train_inputs, train_label, ((np.array(test_inputs)), (np.array(test_label))))
    loss = mean_squared_error(model.predict(np.array(test_inputs)), test_label)
    if loss < min_loss:
       min_loss = loss
...
min_loss = 1e10
for i in range(1,5):
    model = custom_model_7(train_inputs)
    model, history = custom_fit(model, train_inputs, train_label, ((np.array(test_inputs)), (np.array(test_label))))
    loss = mean_squared_error(model.predict(np.array(test_inputs)), test_label)
    if loss < min_loss:
       min_loss = loss
